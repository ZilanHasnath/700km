        ...
        <div className="min-h-screen bg-black text-white flex items-center justify-center px-4 py-24 relative overflow-hidden">
            ...
            <div className="w-full max-w-md bg-white/[0.02] border border-white/20 hover:border-cyan-500/40 transition-all duration-500 p-8 sm:p-10 rounded-3xl shadow-[0_0_50px_rgba(0,0,0,0.9)] backdrop-blur-2xl relative z-10">
                <div className="text-center mb-8">
                    ...
                    <p className="text-xs text-white/50 font-bold uppercase tracking-widest mt-2">Join us and start shopping</p>
                </div>
                ...
                <div className="flex items-center my-6">
                    ...
                    <span className="px-3 text-[10px] font-bold uppercase tracking-widest text-white/40">Or register with email</span>
                    <div className="flex-grow border-t border-white/20" />
                </div>

                <form onSubmit={handleSubmit} className="space-y-5">
                    <div>
                        <label className="block text-xs font-black uppercase tracking-widest text-white/70 mb-2">Full Name</label>
                        <input
                            type="text"
                            value={name}
                    ...
                    <div>
                        <label className="block text-xs font-black uppercase tracking-widest text-white/70 mb-2">Password</label>
                        <input
                            type="password"
                            value={password}
                    ...
                    <div>
                        <label className="block text-xs font-black uppercase tracking-widest text-white/70 mb-2">Delivery Address</label>
                        <textarea
                            value={address}
                            onChange={(e) => setAddress(e.target.value)}
                            placeholder="Enter your full street address..."
                            className="w-full bg-white/5 border border-white/30 hover:border-white/50 text-white text-sm px-4 py-3.5 rounded-2xl focus:outline-none focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/20 transition-all placeholder-white/30 resize-none h-24"
                            required
                        />
                    </div>
                    <button
                ...
                <div className="mt-8 text-center border-t border-white/20 pt-6">
                    <p className="text-xs font-semibold text-white/60 mb-3">Already have an account?</p>
                    <Link
                        href="/login"
